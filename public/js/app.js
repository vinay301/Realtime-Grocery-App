...
function updateCart(grocery) {
  axios.post('/update-cart', grocery).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    ...
    var grocery = JSON.parse(btn.dataset.grocery);
    updateCart(grocery);
    //console.log(grocery);
  });
});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkrealtime_groceryStore"] = self["webpackChunkrealtime_groceryStore"] || [];
